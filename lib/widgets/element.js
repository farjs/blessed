...
//        lines[y].dirty = true;
  ...
  if (this.scrollbar && (yl - yi) < i) {
    ...
    if (cell) {
      ...
      const scrollbarStyle = this.style.scrollbar || this.scrollbar;
      attr = this.sattr(scrollbarStyle,
        scrollbarStyle.fg || this.style.fg,
        scrollbarStyle.bg || this.style.bg);
      if (attr !== cell[0] || ch !== cell[1]) {
        lines[y][x][0] = attr;
        lines[y][x][1] = ch;
        lines[y].dirty = true;
